...
def mean(element):
    ...
    for cp_id, timestamps in cp_timestamps.items():
        cp_interval_means.append(interval_var(timestamps))

    result = numpy.mean(cp_interval_means)
